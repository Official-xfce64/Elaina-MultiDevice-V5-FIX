...
global.swa = 'https://wa.me/' //whatsapp
global.tele = 'https://t.me/' //telegram
global.sdc = 'https://discord.gg/' //discord
global.snh = 'https://nhentai.net/' //nhentai

/*============== PAYMENT ==============*/
global.pdana = '08xx' //pulsa1
global.ppulsa = '08xx' //pulsa2
global.povo = '08xx' //ovo
global.gopay = '08xx' //gopay
global.dana = '08xx' //dana
global.sid = 's.id/yassxofc' //s.id
global.psaweria = 'https://saweria.com/' //saweria

/*============== NOMOR ==============*/
global.nomorwa = '6289525443125' //whatsapp
global.nomorbot = '6289525443125' //nomor Bot
global.nomorown = '6289525443125' //nomor Owner
global.namebot = 'ᴇʟᴀɪɴᴀ ᴀɪ' //nama Bot
global.nameown = 'ʏᴀꜱꜱxᴏꜰᴄ' //nama Owner

/*============== STAFF ==============*/
global.owner = [
  ['6289525443125', 'YASSxOFC', true] //creator/owner
